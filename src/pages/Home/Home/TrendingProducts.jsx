            ...
            <Slider {...settings}> {/* Carousel Component */}
                {products.length > 0 ? (
                    products.map(product => (
                        // Add padding or margin to create a gap between cards
                        <div key={product.id} className="px-2"> {/* Add horizontal padding */}
                            <div className="relative group product-card bg-white shadow-lg rounded-lg overflow-hidden h-96">
